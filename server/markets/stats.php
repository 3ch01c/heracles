...
$params = array("market", "package", "category", "downloads", "rating", "votes", "price", "author", "datePublished", "url"); // package params
$table = "markets";
$response = array();
...
if ($result = $db->query($query)) {
	...
	while ($row = $result->fetch_assoc()) {
		...
		// get avg rating
		$query = "select avg(rating) from markets where category = ";
